...
<CardGroup cols={2}>
  <Card title="Safari PWA Notes (Fork)" icon="mobile-screen" href="/examples/pwa-safari-notes">
    Experimental notes for Safari PWA integration and backend handoff.
  </Card>
  <Card title="Voice Command Flow (Fork)" icon="microchip-ai" href="/examples/voice-command-flow-notes">
    Draft pipeline for voice input to structured CrewAI task execution.
  </Card>
</CardGroup>
